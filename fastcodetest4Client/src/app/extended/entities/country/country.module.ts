...
import { CountryExtendedService, CountryDetailsExtendedComponent, CountryListExtendedComponent, CountryNewExtendedComponent } from './';
...
const entities = [
    CountryDetailsExtendedComponent, CountryListExtendedComponent, CountryNewExtendedComponent 
  ]
@NgModule({
