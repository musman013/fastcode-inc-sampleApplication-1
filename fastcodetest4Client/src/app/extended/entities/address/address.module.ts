...
import { AddressExtendedService, AddressDetailsExtendedComponent, AddressListExtendedComponent, AddressNewExtendedComponent } from './';
...
const entities = [
    AddressDetailsExtendedComponent, AddressListExtendedComponent, AddressNewExtendedComponent 
  ]
@NgModule({
