...
import { InventoryExtendedService, InventoryDetailsExtendedComponent, InventoryListExtendedComponent, InventoryNewExtendedComponent } from './';
...
const entities = [
    InventoryDetailsExtendedComponent, InventoryListExtendedComponent, InventoryNewExtendedComponent 
  ]
@NgModule({
