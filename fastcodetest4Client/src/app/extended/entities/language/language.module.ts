...
import { LanguageExtendedService, LanguageDetailsExtendedComponent, LanguageListExtendedComponent, LanguageNewExtendedComponent } from './';
...
const entities = [
    LanguageDetailsExtendedComponent, LanguageListExtendedComponent, LanguageNewExtendedComponent 
  ]
@NgModule({
