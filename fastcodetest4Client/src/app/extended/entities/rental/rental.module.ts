...
import { RentalExtendedService, RentalDetailsExtendedComponent, RentalListExtendedComponent, RentalNewExtendedComponent } from './';
...
const entities = [
    RentalDetailsExtendedComponent, RentalListExtendedComponent, RentalNewExtendedComponent 
  ]
@NgModule({
