...
import { CustomerExtendedService, CustomerDetailsExtendedComponent, CustomerListExtendedComponent, CustomerNewExtendedComponent } from './';
...
const entities = [
    CustomerDetailsExtendedComponent, CustomerListExtendedComponent, CustomerNewExtendedComponent 
  ]
@NgModule({
