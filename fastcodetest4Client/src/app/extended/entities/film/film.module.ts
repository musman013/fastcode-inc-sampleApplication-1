...
import { FilmExtendedService, FilmDetailsExtendedComponent, FilmListExtendedComponent, FilmNewExtendedComponent } from './';
...
const entities = [
    FilmDetailsExtendedComponent, FilmListExtendedComponent, FilmNewExtendedComponent 
  ]
@NgModule({
