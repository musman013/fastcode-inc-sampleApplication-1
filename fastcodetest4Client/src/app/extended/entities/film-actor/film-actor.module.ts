...
import { FilmActorExtendedService, FilmActorDetailsExtendedComponent, FilmActorListExtendedComponent, FilmActorNewExtendedComponent } from './';
...
const entities = [
    FilmActorDetailsExtendedComponent, FilmActorListExtendedComponent, FilmActorNewExtendedComponent 
  ]
@NgModule({
