...
import { CategoryExtendedService, CategoryDetailsExtendedComponent, CategoryListExtendedComponent, CategoryNewExtendedComponent } from './';
...
const entities = [
    CategoryDetailsExtendedComponent, CategoryListExtendedComponent, CategoryNewExtendedComponent 
  ]
@NgModule({
