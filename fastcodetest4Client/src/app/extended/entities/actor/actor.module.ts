...
import { ActorExtendedService, ActorDetailsExtendedComponent, ActorListExtendedComponent, ActorNewExtendedComponent } from './';
...
const entities = [
    ActorDetailsExtendedComponent, ActorListExtendedComponent, ActorNewExtendedComponent 
  ]
@NgModule({
