...
import { CityExtendedService, CityDetailsExtendedComponent, CityListExtendedComponent, CityNewExtendedComponent } from './';
...
const entities = [
    CityDetailsExtendedComponent, CityListExtendedComponent, CityNewExtendedComponent 
  ]
@NgModule({
