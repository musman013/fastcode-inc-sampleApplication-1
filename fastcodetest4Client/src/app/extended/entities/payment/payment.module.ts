...
import { PaymentExtendedService, PaymentDetailsExtendedComponent, PaymentListExtendedComponent, PaymentNewExtendedComponent } from './';
...
const entities = [
    PaymentDetailsExtendedComponent, PaymentListExtendedComponent, PaymentNewExtendedComponent 
  ]
@NgModule({
