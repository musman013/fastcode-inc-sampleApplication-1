...
import { StaffExtendedService, StaffDetailsExtendedComponent, StaffListExtendedComponent, StaffNewExtendedComponent } from './';
...
const entities = [
    StaffDetailsExtendedComponent, StaffListExtendedComponent, StaffNewExtendedComponent 
  ]
@NgModule({
