...
import { StoreExtendedService, StoreDetailsExtendedComponent, StoreListExtendedComponent, StoreNewExtendedComponent } from './';
...
const entities = [
    StoreDetailsExtendedComponent, StoreListExtendedComponent, StoreNewExtendedComponent 
  ]
@NgModule({
