...
import { FilmCategoryExtendedService, FilmCategoryDetailsExtendedComponent, FilmCategoryListExtendedComponent, FilmCategoryNewExtendedComponent } from './';
...
const entities = [
    FilmCategoryDetailsExtendedComponent, FilmCategoryListExtendedComponent, FilmCategoryNewExtendedComponent 
  ]
@NgModule({
