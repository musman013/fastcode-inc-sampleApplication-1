...
import { ICountry, CountryService, CountryDetailsComponent, CountryListComponent,
	CountryNewComponent } from '../';
...
describe('CountryListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/country/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
