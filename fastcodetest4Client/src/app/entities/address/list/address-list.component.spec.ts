...
import { IAddress, AddressService, AddressDetailsComponent, AddressListComponent,
	AddressNewComponent } from '../';
...
describe('AddressListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/address/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
