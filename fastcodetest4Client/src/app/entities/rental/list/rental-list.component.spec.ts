...
import { IRental, RentalService, RentalDetailsComponent, RentalListComponent,
	RentalNewComponent } from '../';
...
describe('RentalListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/rental/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
