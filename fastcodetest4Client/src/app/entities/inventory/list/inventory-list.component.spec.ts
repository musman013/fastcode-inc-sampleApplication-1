...
import { IInventory, InventoryService, InventoryDetailsComponent, InventoryListComponent,
	InventoryNewComponent } from '../';
...
describe('InventoryListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/inventory/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
