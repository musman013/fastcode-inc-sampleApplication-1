...
import { IStore, StoreService, StoreDetailsComponent, StoreListComponent,
	StoreNewComponent } from '../';
...
describe('StoreListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/store/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
