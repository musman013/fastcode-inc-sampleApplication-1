...
import { IPayment, PaymentService, PaymentDetailsComponent, PaymentListComponent,
	PaymentNewComponent } from '../';
...
describe('PaymentListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/payment/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
