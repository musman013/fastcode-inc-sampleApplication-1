...
import { IStaff, StaffService, StaffDetailsComponent, StaffListComponent,
	StaffNewComponent } from '../';
...
describe('StaffListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/staff/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
