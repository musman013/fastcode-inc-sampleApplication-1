...
import { ILanguage, LanguageService, LanguageDetailsComponent, LanguageListComponent,
	LanguageNewComponent } from '../';
...
describe('LanguageListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/language/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
