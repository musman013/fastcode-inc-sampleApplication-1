...
import { ICategory, CategoryService, CategoryDetailsComponent, CategoryListComponent,
	CategoryNewComponent } from '../';
...
describe('CategoryListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/category/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
