...
import { IActor, ActorService, ActorDetailsComponent, ActorListComponent,
	ActorNewComponent } from '../';
...
describe('ActorListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/actor/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
